...
import (
	...
	"github.com/boxlite-ai/daemon/cmd/daemon/config"
	"github.com/boxlite-ai/daemon/internal/util"
	"github.com/boxlite-ai/daemon/pkg/recording"
	"github.com/boxlite-ai/daemon/pkg/recordingdashboard"
	"github.com/boxlite-ai/daemon/pkg/session"
	"github.com/boxlite-ai/daemon/pkg/ssh"
	"github.com/boxlite-ai/daemon/pkg/terminal"
	"github.com/boxlite-ai/daemon/pkg/toolbox"
...
func run() int {
	...
	toolBoxServer := toolbox.NewServer(toolbox.ServerConfig{
		...
		TelemetryLayer:        c.TelemetryLayer,
