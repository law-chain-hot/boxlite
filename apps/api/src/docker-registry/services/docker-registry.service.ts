...
export class DockerRegistryService {
   ...
   *
   * If an artifact registry _is_ configured for the region identified by the provided _regionId_, only an internal registry that matches the region artifact registry can be returned.
   * If no matching internal registry is found, _null_ will be returned.
   *
   * If an artifact registry _is not_ configured for the provided region, the default internal registry will be returned (if available).
   ...
   *
   * If an artifact registry _is_ configured for the region identified by the provided _regionId_, only a transient registry that matches the region artifact registry can be returned.
   * If no matching transient registry is found, _null_ will be returned.
   *
   * If an artifact registry _is not_ configured for the provided region or no region is provided, the default transient registry will be returned (if available).
   ...
   *
   * If an artifact registry _is_ configured for the region identified by the provided _preferredRegionId_, only a backup registry that matches the region artifact registry can be returned.
   * If no matching backup registry is found, _null_ will be returned.
   *
   * If an artifact registry _is not_ configured for the provided region, a backup registry in the preferred region will be returned (if available).
