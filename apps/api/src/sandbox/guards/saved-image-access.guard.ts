...
@Injectable()
export class SavedImageAccessGuard implements CanActivate {
    ...
    try {
      switch (true) {
        ...
        default: {
          ...
          if (orgAuthContext.role !== SystemRole.ADMIN && savedImage.organizationId !== orgAuthContext.organizationId) {
