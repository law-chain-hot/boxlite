...
export const DockerRegistryApiFactory = function (
  ...
  return {
    ...
    createRegistry(
      ...
      return localVarFp
        .createRegistry(createDockerRegistry, xBoxLiteOrganizationID, options)
    ...
    getTransientPushAccess(
      ...
      return localVarFp
        .getTransientPushAccess(xBoxLiteOrganizationID, regionId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setDefaultRegistry(
      ...
      return localVarFp
        .setDefaultRegistry(id, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateRegistry(
      ...
      return localVarFp
        .updateRegistry(id, updateDockerRegistry, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class DockerRegistryApi extends BaseAPI {
  ...
  public deleteRegistry(id: string, xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .deleteRegistry(id, xBoxLiteOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public getRegistry(id: string, xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .getRegistry(id, xBoxLiteOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public listRegistries(xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .listRegistries(xBoxLiteOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
