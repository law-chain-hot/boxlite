...
// @ts-ignore
import type { BoxliteConfiguration } from '../models'
/**
...
export const ConfigApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BoxliteConfiguration>> {
...
export const ConfigApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    configControllerGetConfig(options?: RawAxiosRequestConfig): AxiosPromise<BoxliteConfiguration> {
