...
export const WorkspaceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createBackupWorkspaceDeprecated(
      ...
      return localVarFp
        .createBackupWorkspaceDeprecated(workspaceId, xBoxLiteOrganizationID, options)
    ...
    createWorkspaceDeprecated(
      ...
      return localVarFp
        .createWorkspaceDeprecated(createWorkspace, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    deleteWorkspaceDeprecated(
      ...
      return localVarFp
        .deleteWorkspaceDeprecated(workspaceId, force, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getBuildLogsWorkspaceDeprecated(
      ...
      return localVarFp
        .getBuildLogsWorkspaceDeprecated(workspaceId, xBoxLiteOrganizationID, follow, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getPortPreviewUrlWorkspaceDeprecated(
      ...
      return localVarFp
        .getPortPreviewUrlWorkspaceDeprecated(workspaceId, port, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getWorkspaceDeprecated(
      ...
      return localVarFp
        .getWorkspaceDeprecated(workspaceId, xBoxLiteOrganizationID, verbose, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listWorkspacesDeprecated(
      ...
      return localVarFp
        .listWorkspacesDeprecated(xBoxLiteOrganizationID, verbose, labels, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutostopIntervalWorkspaceDeprecated(
      ...
      return localVarFp
        .setAutostopIntervalWorkspaceDeprecated(workspaceId, interval, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    startWorkspaceDeprecated(
      ...
      return localVarFp
        .startWorkspaceDeprecated(workspaceId, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    stopWorkspaceDeprecated(
      ...
      return localVarFp
        .stopWorkspaceDeprecated(workspaceId, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updatePublicStatusWorkspaceDeprecated(
      ...
      return localVarFp
        .updatePublicStatusWorkspaceDeprecated(workspaceId, isPublic, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
