...
export const ObjectStorageApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getPushAccess(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPushAccess(xBoxLiteOrganizationID, options)
...
export const ObjectStorageApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getPushAccess(xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<StorageAccessDto> {
      return localVarFp.getPushAccess(xBoxLiteOrganizationID, options).then((request) => request(axios, basePath))
    },
  }
}
...
export class ObjectStorageApi extends BaseAPI {
  ...
  public getPushAccess(xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ObjectStorageApiFp(this.configuration)
      .getPushAccess(xBoxLiteOrganizationID, options)
