...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    regenerateArtifactRegistryCredentials: async (
      id: string,
      xBoxLiteOrganizationID?: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/regions/{id}/regenerate-artifact-registry-credentials`.replace(
        `{${'id'}}`,
     ...
     * @throws {RequiredError}
     */
    updateExperimentalConfig: async (
      organizationId: string,
      ...
      const localVarPath = `/organizations/{organizationId}/experimental-config`.replace(
        `{${'organizationId'}}`,
        encodeURIComponent(String(organizationId)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    updateOrganizationName: async (
      ...
      const localVarPath = `/organizations/{organizationId}/name`.replace(
        `{${'organizationId'}}`,
        encodeURIComponent(String(organizationId)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const OrganizationsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async regenerateArtifactRegistryCredentials(
      id: string,
      xBoxLiteOrganizationID?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactRegistryCredentials>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.regenerateArtifactRegistryCredentials(
        id,
        xBoxLiteOrganizationID,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.regenerateArtifactRegistryCredentials']?.[localVarOperationServerIndex]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async updateExperimentalConfig(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateExperimentalConfig(
        organizationId,
        requestBody,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.updateExperimentalConfig']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateOrganizationName(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateOrganizationName(
        organizationId,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.updateOrganizationName']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateRegion(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.updateRegion']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const OrganizationsApiFactory = function (
  ...
  return {
    ...
    createRegion(
      ...
      return localVarFp
        .createRegion(createRegion, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listAvailableRegions(
      ...
      return localVarFp
        .listAvailableRegions(xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    regenerateArtifactRegistryCredentials(
      id: string,
      xBoxLiteOrganizationID?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ArtifactRegistryCredentials> {
      return localVarFp
        .regenerateArtifactRegistryCredentials(id, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    regenerateProxyApiKey(
      ...
      return localVarFp
        .regenerateProxyApiKey(id, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    regenerateSshGatewayApiKey(
      ...
      return localVarFp
        .regenerateSshGatewayApiKey(id, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateOrganizationName(
      ...
      return localVarFp
        .updateOrganizationName(organizationId, updateOrganizationName, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateRegion(
      ...
      return localVarFp
        .updateRegion(id, updateRegion, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export class OrganizationsApi extends BaseAPI {
  ...
  public deleteRegion(id: string, xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return OrganizationsApiFp(this.configuration)
      .deleteRegion(id, xBoxLiteOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public getRegionById(id: string, xBoxLiteOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return OrganizationsApiFp(this.configuration)
      .getRegionById(id, xBoxLiteOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof OrganizationsApi
   */
  public regenerateArtifactRegistryCredentials(
    id: string,
    xBoxLiteOrganizationID?: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof OrganizationsApi
   */
  public updateExperimentalConfig(
    organizationId: string,
    requestBody?: { [key: string]: any },
    options?: RawAxiosRequestConfig,
  ) {
