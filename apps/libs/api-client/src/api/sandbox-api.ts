...
export const SandboxApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {Array<string>} [templates] List of template names to filter by
...
export const SandboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createBackup(
      ...
      return localVarFp
        .createBackup(sandboxIdOrName, xBoxLiteOrganizationID, options)
    ...
    createSandbox(
      ...
      return localVarFp
        .createSandbox(createSandbox, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    createSshAccess(
      ...
      return localVarFp
        .createSshAccess(sandboxIdOrName, xBoxLiteOrganizationID, expiresInMinutes, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    deleteSandbox(
      ...
      return localVarFp
        .deleteSandbox(sandboxIdOrName, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    expireSignedPortPreviewUrl(
      ...
      return localVarFp
        .expireSignedPortPreviewUrl(sandboxIdOrName, port, token, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * This endpoint is deprecated. Use `getBuildLogsUrl` instead.
    ...
    getBuildLogs(
      ...
      return localVarFp
        .getBuildLogs(sandboxIdOrName, xBoxLiteOrganizationID, follow, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getBuildLogsUrl(
      ...
      return localVarFp
        .getBuildLogsUrl(sandboxIdOrName, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getPortPreviewUrl(
      ...
      return localVarFp
        .getPortPreviewUrl(sandboxIdOrName, port, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getSandbox(
      ...
      return localVarFp
        .getSandbox(sandboxIdOrName, xBoxLiteOrganizationID, verbose, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Retrieve OTEL logs for a sandbox within a time range
    ...
    getSandboxLogs(
      ...
      return localVarFp
        .getSandboxLogs(sandboxId, from, to, xBoxLiteOrganizationID, page, limit, severities, search, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Retrieve OTEL metrics for a sandbox within a time range
    ...
    getSandboxMetrics(
      ...
      return localVarFp
        .getSandboxMetrics(sandboxId, from, to, xBoxLiteOrganizationID, metricNames, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Retrieve all spans for a specific trace
    ...
    getSandboxTraceSpans(
      ...
      return localVarFp
        .getSandboxTraceSpans(sandboxId, traceId, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Retrieve OTEL traces for a sandbox within a time range
    ...
    getSandboxTraces(
      ...
      return localVarFp
        .getSandboxTraces(sandboxId, from, to, xBoxLiteOrganizationID, page, limit, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getSandboxesForRunner(
      ...
      return localVarFp
        .getSandboxesForRunner(xBoxLiteOrganizationID, states, skipReconcilingSandboxes, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getSignedPortPreviewUrl(
      ...
      return localVarFp
        .getSignedPortPreviewUrl(sandboxIdOrName, port, xBoxLiteOrganizationID, expiresInSeconds, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getToolboxProxyUrl(
      ...
      return localVarFp
        .getToolboxProxyUrl(sandboxId, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listSandboxes(
      ...
      return localVarFp
        .listSandboxes(xBoxLiteOrganizationID, verbose, labels, includeErroredDeleted, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    recoverSandbox(
      ...
      return localVarFp
        .recoverSandbox(sandboxIdOrName, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    replaceLabels(
      ...
      return localVarFp
        .replaceLabels(sandboxIdOrName, sandboxLabels, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    resizeSandbox(
      ...
      return localVarFp
        .resizeSandbox(sandboxIdOrName, resizeSandbox, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutoDeleteInterval(
      ...
      return localVarFp
        .setAutoDeleteInterval(sandboxIdOrName, interval, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutostopInterval(
      ...
      return localVarFp
        .setAutostopInterval(sandboxIdOrName, interval, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    startSandbox(
      ...
      return localVarFp
        .startSandbox(sandboxIdOrName, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    stopSandbox(
      ...
      return localVarFp
        .stopSandbox(sandboxIdOrName, xBoxLiteOrganizationID, force, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateLastActivity(
      ...
      return localVarFp
        .updateLastActivity(sandboxId, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updatePublicStatus(
      ...
      return localVarFp
        .updatePublicStatus(sandboxIdOrName, isPublic, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateSandboxState(
      ...
      return localVarFp
        .updateSandboxState(sandboxId, updateSandboxStateDto, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    validateSshAccess(
      ...
      return localVarFp
        .validateSshAccess(token, xBoxLiteOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
