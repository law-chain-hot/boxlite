...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    logoutControllerEndSession: async (
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async logoutControllerEndSession(
      postLogoutRedirectUri?: string,
      idTokenHint?: string,
      state?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.logoutControllerEndSession(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.logoutControllerEndSession']?.[localVarOperationServerIndex]?.url
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    logoutControllerEndSession(
      ...
      return localVarFp
        .logoutControllerEndSession(postLogoutRedirectUri, idTokenHint, state, options)
...
export class AuthApi extends BaseAPI {
   ...
   * @memberof AuthApi
   */
  public logoutControllerEndSession(
    postLogoutRedirectUri?: string,
    idTokenHint?: string,
    state?: string,
    options?: RawAxiosRequestConfig,
