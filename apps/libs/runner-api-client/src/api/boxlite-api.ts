...
export const BoxliteApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    v1BoxesBoxIdExecutionsExecIdAttachGet: async (
      boxId: string,
      execId: string,
...
export const BoxliteApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async v1BoxesBoxIdExecutionsExecIdAttachGet(
      boxId: string,
      execId: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1BoxesBoxIdExecutionsExecIdAttachGet(
        boxId,
        execId,
        options,
      )
      ...
      const localVarOperationServerBasePath =
        operationServerMap['BoxliteApi.v1BoxesBoxIdExecutionsExecIdAttachGet']?.[localVarOperationServerIndex]?.url
...
export const BoxliteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    v1BoxesBoxIdExecutionsExecIdAttachGet(
      ...
      return localVarFp
        .v1BoxesBoxIdExecutionsExecIdAttachGet(boxId, execId, options)
...
export class BoxliteApi extends BaseAPI {
  ...
  public v1BoxesBoxIdExecutionsExecIdAttachGet(boxId: string, execId: string, options?: RawAxiosRequestConfig) {
    return BoxliteApiFp(this.configuration)
      .v1BoxesBoxIdExecutionsExecIdAttachGet(boxId, execId, options)
