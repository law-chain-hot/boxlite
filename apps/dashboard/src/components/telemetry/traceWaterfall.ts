...
import type { AdminObservabilityTraceSpan } from '@/hooks/useAdminObservability'

export interface TraceWaterfallRow extends AdminObservabilityTraceSpan {
  depth: number
  durationMs: number
...
interface SpanNode extends AdminObservabilityTraceSpan {
  children: SpanNode[]
}
...
export function buildTraceWaterfallRows(spans: AdminObservabilityTraceSpan[] | undefined): TraceWaterfallRow[] {
