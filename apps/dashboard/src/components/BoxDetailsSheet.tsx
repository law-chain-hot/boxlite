...
const BoxDetailsSheet: React.FC<BoxDetailsSheetProps> = ({
  ...
  if (!box) return null
  const templateDisplayName = getTemplateDisplayName(box.template)
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  <div className="min-w-0">
                    <p className="truncate text-sm font-medium">{box.template ? templateDisplayName : '-'}</p>
                    {box.template && templateDisplayName !== box.template && (
                      <p className="truncate text-xs text-muted-foreground">{box.template}</p>
                    )}
                  </div>
