...
function baseParams(codeSnippetLanguage: CodeLanguage): CodeSnippetParams {
  return {
    ...
    config: {
      ...
      useSandboxCreateParams: false,
      createSandboxFromImage: false,
      createSandboxFromTemplate: false,
      useCustomSandboxTemplateName: false,
      useLanguageParam: false,
      createSandboxParamsExist: false,
