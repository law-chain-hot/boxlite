...
import { useCreateBoxFromTemplateMutation } from '@/hooks/mutations/useCreateBoxFromTemplateMutation'
...
export const CreateBoxSheet = ({
  ...
  const { reset: resetCreateBoxMutation, ...createBoxMutation } = useCreateBoxFromTemplateMutation()
