...
func (r WorkspaceAPICreateBackupWorkspaceDeprecatedRequest) XBoxLiteOrganizationID(xBoxLiteOrganizationID string) WorkspaceAPICreateBackupWorkspaceDeprecatedRequest {
...
// Use with JWT to specify the organization ID
func (r WorkspaceAPIGetBuildLogsWorkspaceDeprecatedRequest) XBoxLiteOrganizationID(xBoxLiteOrganizationID string) WorkspaceAPIGetBuildLogsWorkspaceDeprecatedRequest {
	r.xBoxLiteOrganizationID = &xBoxLiteOrganizationID
	return r
}
